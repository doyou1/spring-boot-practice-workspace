package com.springsecurity.security5_practice2;

import com.springsecurity.security5_practice2.context.auth.domain.PerLevel;
...
@EnableJpaAuditing	// 무슨 역할인가염?
@SpringBootApplication
public class Security5Practice2Application {

	public static void main(String[] args) {
		SpringApplication.run(Security5Practice2Application.class, args);
	}
